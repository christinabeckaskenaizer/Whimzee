...
<<<<<<< HEAD
        ...
        <div className="relative inline-block text-left">
          <div>
            <button type="button" className="gap-x-1.5 rounded-md bg-white text-sm font-semibold md:dark:text-black md:hover:text-green-800" id="menu-button" aria-expanded="true" aria-haspopup="true">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <form>
            <div className="flex shadow">
              ...
              <div
                id="dropdown"
                className="z-10 hidden bg-white divide-y divide-green-100 rounded-lg shadow w-44"
              ></div>
              <div className="relative w-full">
                <input
                  type="search"
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none0"
