...
export default function ListingCard({ picture, name, isNew, price }) {
    ...
    return (
        <div className="overflow-hidden m-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-slate-50 dark:border-gray-700">
            <div className="rounded-t-lg overflow-hidden h-48 w-96 object-none object-center flex items-center justify-center">
                <img className="rounded-t-lg object-fill" src={picture} alt="product image" />
            </div>
